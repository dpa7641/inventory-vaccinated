...
export const Vaccine = () => {
  ...
  const handleSubmitSave = async () => {
    try {
      await axios.post(VACCINE_URL, form);
      setForm({});
      handleModal();
      getVaccine();
    } catch (err) {
  ...
  const handleSubmitUpdate = async (id) => {
    try {
      await axios.put(`${VACCINE_URL}/${id}`, editItem);
      setEditItem({});
      handleEdit();
      getVaccine();
    } catch (err) {
  ...
  const handleSubmitDelete = async (id) => {
    try {
      await axios.delete(`${VACCINE_URL}/${id}`);
      setEditItem({});
      handleConfirm();
      getVaccine();
    } catch (err) {
    ...
    <>
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        <Box displey="flex" justifyContent="space-between">
          ...
          <Typography>Crear Vacuna</Typography>
        </Box>
